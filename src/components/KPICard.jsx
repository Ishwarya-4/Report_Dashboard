export const KPICard = ({ title, value }) => {
  return (
    <div className="bg-primary rounded-lg p-3 text-center shadow-[0_2px_6px_rgba(0,0,0,0.1)] hover:shadow-[0_3px_8px_rgba(0,0,0,0.15)] transition-shadow duration-200 h-20 flex flex-col justify-center w-full">
